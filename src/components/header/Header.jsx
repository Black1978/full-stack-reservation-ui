...
function Header(props) {
    ...
    const handleSearch = () => {
        navigate('/hotels', { state: { distanation, date, options } })
    }

    return (
        <div className='header'>
            <div
                className={props.type !== 'list' ? 'headerContainer' : 'headerContainer  listMode'}
            >
                        ...
                        <div className='headerSearch'>
                            <div className='headerSearchItem'>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setDistanation(e.target.value)}
                                    value={distanation}
                                />
                            </div>
                            <div className='headerSearchItem'>
